#' Assemble Play-by-Play Data Function //2018-2019 NHL SEASON ONLY//
#'
...
assembleGame2 <- function(url)
{
  ...
  home <- substr(as.character(tables2[[1]]$V8[19]), 1, 3)
  away <- substr(as.character(tables2[[1]]$V7[19]), 1, 3)
